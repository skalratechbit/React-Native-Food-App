...
import { FONT_SCALLING } from '../../config/common_styles';
    ...
    class  ExtraPopUp extends   Component {
        state={
                ...
                <Modal
                    ...
                    <View style={styles.modalBackground}>
                        <View style={styles.popUpContainerView}>
                            <View style={[styles.headingViewStyle,{backgroundColor:APP_COLOR_RED}]}>
                                ...
                                <View style={styles.activityIndicatorWrapper}>
                                    <Text allowFontScaling={FONT_SCALLING}
                                          style={[styles.subHeadingStyle,{color:APP_COLOR_RED,textAlign:'center'}]}>{this.props.selectedSubHeading && this.props.selectedSubHeading.toUpperCase()}</Text>
                                    <Text allowFontScaling={FONT_SCALLING}
