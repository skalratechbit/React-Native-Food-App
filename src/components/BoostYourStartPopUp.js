...
class BoostYourStartPopUp extends Component {
    state = {
    ...
    render() {
        return (
            <Modal transparent={true} visible={this.state.modalVisibilty} onRequestClose={this.handleRequestClose}>
                    ...
                    <View style={styles.popUpContainerView}>
                        <View
                            ...
                            <Text allowFontScaling={FONT_SCALLING} style={styles.headingTextStyle}>
                                {this.props.selectedHeading.toUpperCase()}
                            </Text>
                        </View>
                        <View style={styles.activityIndicatorWrapper}>
                            <Text
                                ...
                                {this.props.selectedSubHeading.toUpperCase()}
                            </Text>
